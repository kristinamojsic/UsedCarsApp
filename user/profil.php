      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12" style="text-align: center;">
            <div class="well">
              <h3 class="box-title" style="color:rgba(120,22,77,0.9)"><br><b><?php echo $_SESSION['email']; ?></b></h3>
              </div>
              <div class="box-body no-padding">
                <ul class="nav nav-pills nav-justified">
                      <li class="active"><a href="profil.php" style="background-color:rgba(120,22,77,0.9) !important;border-top-color:rgba(120,22,77,0.9) !important"><i class="fa fa-dashboard"></i> Statistika</a></li>
          ...
          <div class="col-md-12 bg-gray padding-3">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="info-box bg-teal" style="background-color:#98adbb !important;">
                  <span class="info-box-icon bg-black"><i class="ion ion-briefcase"></i></span>
                  <div class="info-box-content">
                    <span class="info-box-text">Postavljenih oglasa: </span>
                    <?php
                    $sql = "SELECT * FROM oglas  WHERE oglas.idKorisnika='$_SESSION[autorizovan]'";
